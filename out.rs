            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                ...
                fn expecting(
                    ...
                    _serde::export::Formatter::write_str(__formatter, "struct Interactive")
                }
                #[inline]
                fn visit_seq<__A>(
                    self,
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let __field0 = match __field0 {
                        ...
                        _serde::export::None => match _serde::private::de::missing_field("one") {
                            _serde::export::Ok(__val) => __val,
                            _serde::export::Err(__err) => {
                                return _serde::export::Err(__err);
                            }
                    ...
                    let __field1 = match __field1 {
                        ...
                        _serde::export::None => match _serde::private::de::missing_field("two") {
                            _serde::export::Ok(__val) => __val,
                            _serde::export::Err(__err) => {
                                return _serde::export::Err(__err);
                            }
                    ...
                    let __field2 = match __field2 {
                        ...
                        _serde::export::None => match _serde::private::de::missing_field("three") {
                            _serde::export::Ok(__val) => __val,
                            _serde::export::Err(__err) => {
                                return _serde::export::Err(__err);
                            }
            ...
            const FIELDS: &'static [&'static str] = &["one", "two", "three"];
...
pub fn interact(mut interactive: Interactive) -> Interactive {
    ...
    interactive.three = $crate::fmt::format($crate::fmt::Arguments::new_v1_formatted(
        &["embedded: "],
